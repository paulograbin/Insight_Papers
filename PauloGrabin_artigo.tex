...
\titulo{Exemplo de Artigo no Padrão da UNISINOS: Versão \LaTeX}
\autor{Fulano de Tal\footnote{Aluno do curso de Ciência da Computação.  Email: fulano@tal.com}}
\autor{Beltrano da Silva\footnote{Orientador, professor da Unisinos, doutor em Ciência da Computação pela Universidade de Stanford (1995), Mestre em Ciência da Computação pela Universidade de Calcutá (1983).  Email: professor@unisinos.br}}
