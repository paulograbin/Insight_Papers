...
Agradeço primeiramente ao meu orientador Cristiano, pessoa a quem eu muito admiro, pelas valiosas conversas, seu auxilio incomparável, e por sua disponibilidade sempre que necessário.

Aos meus pais, pelo carinho e compreensão demonstrados e por todo o incentivo na realização dos meus sonhos.

A minha namorada Victoria, por ficar sempre do meu lado e por me motivar a superar os desafios.
...
Nessa seção cabe uma figura mostrando o problema atual e como será resolvido pelo trabalho sendo realizado.
	...
	\section{Objetivos}
Apresenta o objetivo principal do trabalho e os objetivos secundários: Importante: objetivo é o que será feito e não como será feito (isso é metodologia).
...
Neste capítulo são apresentadas 3 ou 4 (TODO) soluções relacionadas com o tema. Estas foram selecionadas por possuírem proposito semelhante bem como características desejadas por esse trabalho. Ao final desde capitulo, no item~\ref{comparacaoTrabs} é apresentado um comparativo entre os trabalhos selecionados, destacando pontos que são relevantes para o desenvolvimento da arquitetura do presente trabalho.
	...
	\section{Tirésias: um modelo para acessibilidade ubíqua orientado à deficiência visual}
