...
% A comunicação entre clientes e servidores UbiHealth é realizada sobre o protocolo HTTPS. As mensagens trocadas entre clientes e servidores utilizam a arquitetura de serviços REST, sigla originária do inglês e que significa Transferência de Estado Representativo (Representational State Transfer). A arquitetura REST foi escolhida por ser de fácil implementação e reconhecida por prover melhor escalabilidade ao sistema. Os arquivos binários no formato DICOM também serão transferidos entre cliente e servidor através da arquitetura REST e do protocolo HTTPS
% A Figura 7 traz um diagrama de sequência que tem o propósito de facilitar o entendimento da comunicação entre os diferentes atores envolvidos. O exemplo mostra as ações de um usuário em seu dispositivo móvel utilizando um cliente UbiHealth que comunica-se com servidores UbiHealth. O usuário em questão é um médico generalista que abre o caso de um paciente. Em seguida o usuário busca auxílio de um especialista adicionando o mesmo ao caso. Para auxiliar o especialista no diagnóstico, o usuário generalista busca um registro médico que possa ser adicionado ao caso para ser analisado pelo especialista. Esta busca retornará do servidor um arquivo no formato DICOM contendo uma fotografia, o qual o usuário adicionará ao caso. Junto com a fotografia o usuário adicionará também uma mensagem explicando seu ponto de vista sobre o registro e a relevância para este caso.
