...
Em \citetexto{Ganz2011} e \citetexto{Ganz2012} apresentam um modelo blablabla
	...
	O Tirésias funciona obtendo informações de localização do usuário através do GPS contido no smartphone, e, baseado nisso o sistema exibe recursos de acessibilidade disponiveis nas proximidades do usuário. Algumas das funcionalidades oferecidas são...
