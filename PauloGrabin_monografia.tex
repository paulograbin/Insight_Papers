...
Os requisitos funcionais elicitados para o modelo são:
	...
	\begin{itemize} % breve descrição, atores, condições previas, fluxo de eventos (basico e alternativo), pós condições 
		...
		\item \textbf{RF08 - Enviar pedido de ajuda:} o usuário poderá enviar aos administradores um pedido de ajuda informando o seu local atual, para que alguém seja enviado para socorrer o usuário.
		
		% ADMIN
		\item \textbf{RF09 - Manter locais:} o administrador poderá adicionar, editar, ou excluir locais cadastrados no modelo.
		
		\item \textbf{RF10 - Manter beacons:} o administrador poderá adicionar, editar, ou excluir beacons cadastrados no modelo.

		\item \textbf{RF11 - Sincronização:} o administrator poderá alterar a periodicidade das sincronizações do aplicativo com o servidor.
...
\begin{itemize}
	...
	\item \textbf{RNF07 - Usabilidade - Adaptação ao contexto:} o sistema deverá identificar o contexto do usuário através do uso da localização, afim de exibir os locais mais relevantes e fornecer os próximos passos da navegação.
...
Explicar como beacons funcionam...
